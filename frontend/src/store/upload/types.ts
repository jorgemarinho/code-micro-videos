...
export interface UploadProgressAction extends AnyAction {
    payload: {
        video: Video,
        fileField: string,
        progress: number,
...
export type Actions = AddUploadAction | RemoveUploadAction | UploadProgressAction | SetUploadErrorAction;